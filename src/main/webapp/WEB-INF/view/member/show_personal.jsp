...
<div class="container-500 out-align-center">
	...
	<div class="myrow input-group input-group-lg">
		...
		<input type="text" class="form-control" name="phone"
			value="01011112222" readonly>
	</div>
	<div class="myrow input-group input-group-lg">
		<span class="input-group-addon glyphicons-tent" id="sizing-addon1"><i
			class="glyphicon glyphicon-tent"></i></span> <input type="text"
			class="form-control" name="address" value="서울특별시 강남구" readonly>
	</div>
	<div class="myrow input-group input-group-lg">
		<span class="input-group-addon" id="sizing-addon1"><i
			class="glyphicon glyphicon-tent"></i></span> <input type="text"
			class="form-control" name="address_detail" value="강남역 지하철 2호선 4번 출구" readonly>
	</div>
