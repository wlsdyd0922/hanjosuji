...
<form action="${pageContext.request.contextPath }/member/register_company" method="post">
	<div class="container-30 out-align-center">
                ...
                <div class="myrow input-group input-group-lg">
                    ...
                    <input type="text" class="form-control" name="company" placeholder="회사명을 입력해주세요">
                </div>
                <div class="myrow input-group input-group-lg">
                    <span class="input-group-addon" id="sizing-addon1"><i class="glyphicon glyphicon-user"></i></span>
                    <input type="text" class="form-control" name="ceo" placeholder="관리자 성함을 입력해주세요">
                </div>
                <div class="myrow input-group input-group-lg">
                    <h4>설립일을 선택하세요</h4>
                </div>
                <div class="myrow input-group input-group-lg">
                    ...
                    <input id="someDate" class="form-control" type="date" name="birth">
                </div>
                <div class="myrow">
                ...
                <div class="myrow input-group input-group-lg">
                    <span class="input-group-addon" id="sizing-addon1"><i class="glyphicon glyphicon-user"></i></span>
                    <input type="text" class="form-control" name="employee" placeholder="근무인원을 입력하세요">
                </div>
                <div class="myrow input-group input-group-lg">
                    <span class="input-group-addon" id="sizing-addon1"><i class="glyphicon glyphicon-bitcoin"></i></span>
                    <input type="text" class="form-control" name="sales" placeholder="매출액을 입력하세요">
                </div>
