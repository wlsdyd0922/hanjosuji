...
<div class="empty-row"></div>
<div class="container-60 out-align-center div-2 padding">
	<div style="width: 50%; height: 50%" class="myrow">
		<div style="width: 60%; height: 60%" class="out-align-center">
			<button class="btn btn-primary form-btn-full height-100"
				onclick="location.href = '${pageContext.request.contextPath }/member/register_personal'">
	...
	<div style="width: 50%; height: 50%" class="myrow">
		<div style="width: 60%; height: 60%" class="out-align-center">
			<button class="btn btn-primary form-btn-full height-100"
				onclick="location.href = '${pageContext.request.contextPath }/member/register_company'">
