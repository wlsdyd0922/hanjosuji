...
<form action="${pageContext.request.contextPath }/member/edit_personal" method="post">
<div class="empty-row"></div>
    <div class="container-30 out-align-center">
        <div class="myrow input-group input-group-lg">
            <span class="input-group-addon" id="sizing-addon1"><i class="glyphicon glyphicon-envelope"></i></span>
        <input type="text" class="form-control" name="id" value="1234@1234.com" readonly>
        </div>
        <div class="myrow input-group input-group-lg">
        ...
        <div class="myrow div-2">
            <input class="btn btn-primary btn-lg form-btn-full" type="submit" value="수정완료">
