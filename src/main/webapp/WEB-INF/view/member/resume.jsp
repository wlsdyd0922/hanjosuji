...
<form action="#" method="post">
                <div class="container-70 out-align-center">
                    ...
                    <div class="myrow div-2" style="height: 116px;">
                        ...
                        <textarea class="container-100 height-100 textarea" name="certification"></textarea>
                    </div>
                    <hr class="style-one">
                    <div class="myrow div-2" style="height: 116px;">
                    ...
                    <div class="myrow in-align-center">
                        <input type="submit" class="btn btn-primary btn-md" value="등록">
                        <input type="button" class="btn btn-primary btn-md" value="뒤로가기">
                    </div>
                </div>
            </form>
