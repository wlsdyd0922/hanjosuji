...
<form action="${pageContext.request.contextPath}/company/boardwrite"
	method="post">
	...
	<div class="container-1000 out-align-center">
		<div class="div-2">
			...
			<div class="container-80">
				<input class="form-input-full" type="text">
			</div>
		</div>
		<div class="div-2">
			<div class="container-20">회사명</div>
			<div class="container-80">
				<input class="form-input-full" type="text"> <select>
					<option>1</option>
					<option>2</option>
					<option>3</option>
				</select>
		...
		<div class="div-2">
			...
			<div class="container-80">
				<input class="form-input-full" type="text" placeholder="숫자로 입력해 주세요">
			</div>
		</div>
		<div class="div-2">
		...
		<div class="div-2">
			...
			<div class="container-80">
				<textarea class="textarea container-100 height-100"></textarea>
			</div>
		</div>
